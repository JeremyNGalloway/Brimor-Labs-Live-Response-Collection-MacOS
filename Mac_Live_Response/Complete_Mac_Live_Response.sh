...
if [[ $EUID -ne 0 ]]; then
	...
	#Running Memory Dump Module
	echo ""
	echo "***** Beginning Mac Memory Dump module *****"
	source "${directorywherescriptrunsfrom}/Modules/Mac-MemoryDump.sh"
	echo "***** Ending Mac Memory Dump module *****"
	#Running Disk Imaging Module
	echo ""
	echo "***** Beginning Mac Disk Imaging module *****"
	source "${directorywherescriptrunsfrom}/Modules/Mac-DiskImaging.sh"
	echo "***** Ending Mac Disk Imaging module *****"
